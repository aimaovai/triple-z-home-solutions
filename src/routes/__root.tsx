...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Triple Z Home Solutions | Houston Handyman & Remodeling" },
      {
        name: "description",
        content:
          "Reliable handyman and remodeling services for homes and businesses across the greater Houston area.",
      },
      { name: "author", content: "Triple Z Home Solutions" },
      { property: "og:site_name", content: "Triple Z Home Solutions" },
